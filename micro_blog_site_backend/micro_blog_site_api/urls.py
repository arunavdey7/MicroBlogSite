...
from micro_blog_site_api.views import dislike, new_post, register_author, get_author_info, login, get_all_posts,new_post, like, dislike, comment, uncomment, get_comments_for_post,remove_post
...
urlpatterns = [
    ...
    path('api/removepost/', remove_post),
]